...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { done: @office.done, phone: @office.phone, physician_id: @office.physician_id, street: @office.street, zip: @office.zip } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { done: @office.done, phone: @office.phone, physician_id: @office.physician_id, street: @office.street, zip: @office.zip } }
